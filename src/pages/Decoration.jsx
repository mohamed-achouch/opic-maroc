...
import decorationBanner from "../assets/services/DecorationBanner.jpg";
import decorationContent from "../assets/services/decorationContent.jpg";
import OpicBanner from "../components/OpicBanner";
const Decoration = () => {
  return (
    <div>
      <OpicBanner desc="" title="Decoration" image={decorationBanner} />
          ...
          <div className=" flex gap-3 flex-col">
            ...
            <p className=" text-justify text-[13px] sm:text-[14px] md:text-[17px] lg:text-[1.125rem] leading-[24px] text-black/90">
              <ul className=" flex flex-col gap-4">
                <li><span className=" text-custom-blue">❑</span>  Agencement</li>
                <li><span className=" text-custom-blue">❑</span>  Habillage</li>
                <li><span className=" text-custom-blue">❑</span>  intérieur et extérieur</li>
                <li><span className=" text-custom-blue">❑</span>  Faux plafond décoratif</li>
                <li><span className=" text-custom-blue">❑</span>  Mobilier et Tapisserie</li>
                <li><span className=" text-custom-blue">❑</span>  Peinture décorative</li>
                <li><span className=" text-custom-blue">❑</span>  Revêtement décoratif</li>
                <li><span className=" text-custom-blue">❑</span>  Aménagement des espaces </li>
              </ul>
            </p>           
          </div>
        </div>
