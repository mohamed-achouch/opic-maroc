...
import structureBanner from "../assets/services/structureBanner.jpg"
import structureContent from "../assets/services/structureContent.jpg"
import OpicBanner from '../components/OpicBanner'
const Structure = () => {
  return (
    <div>
        <OpicBanner image={structureBanner} desc="" title="Structure"/>
          ...
          <div className=" flex gap-3 flex-col">
            ...
            <p className=" text-justify text-[13px] sm:text-[14px] md:text-[17px] lg:text-[1.125rem] leading-[24px] text-black/90">
              <ul className=" flex flex-col gap-2 md:gap-4">
                <li><span className=" text-custom-blue">❑</span>   Gros œuvre</li>
                <li><span className=" text-custom-blue">❑</span>  Charpente métallique</li>
                <li><span className=" text-custom-blue">❑</span>  Etanchéité</li>
                <li><span className=" text-custom-blue">❑</span>  Dallage industrie</li>
              </ul>
            </p>           
          </div>
        </div>
